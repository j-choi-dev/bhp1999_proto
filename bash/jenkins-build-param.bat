...
set EDITOR_PATH=C:\Program Files\Unity\Hub\Editor\2019.4.40f1\Editor\Unity.exe
...
"%EDITOR_PATH%" -projectPath "%PARENT_PATH%" -executeMethod StudioRomBuild.Editor.View.RomBuildView.%TARGET_METHOD% -batchmode -quit -logFile "%LOG_PATH%" /root_path "%ROOT_PATH%" /build_version "%BUILD_VERSION%"
type "%LOG_PATH%"
